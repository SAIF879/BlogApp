package com.example.blogapp.data.util


import android.util.Log
import com.chuckerteam.chucker.api.ChuckerCollector
import com.chuckerteam.chucker.api.ChuckerInterceptor
import com.example.blogapp.BlogApplication
...
class OkHttpClientHelper {
    ...
    fun getOkHttpClient(): OkHttpClient {
        val httpCacheDirectory = File(BlogApplication.instance?.cacheDir, "http-cache")
    ...
    private fun getChuckerInterceptor(): ChuckerInterceptor? {
        ...
        val context = BlogApplication.instance
        return context?.let {
